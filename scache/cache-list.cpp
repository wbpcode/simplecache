...
CacheListNode *CacheListNode::getNext() { return m_next; }

void CacheListNode::setPrev(CacheListNode *prev) { m_prev = prev; }

CacheListNode *CacheListNode::getPrev() { return m_prev; }

void CacheListNode::setValue(CacheObject *value) { m_value = value; }
...
CacheListNode *CacheList::getHead() { return m_head; }
